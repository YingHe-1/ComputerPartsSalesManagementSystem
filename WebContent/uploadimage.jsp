    ...
    <div class="leftpanel">
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href=""><span class="iconfa-pencil"></span>首页管理</a>
                	<ul style="display:block;">
                        <li class="active"><a href="uploadimage.jsp">更换轮播图片</a></li>
                    </ul>
                </li>
            </ul>
        </div><!--leftmenu-->
		...
		<div class="rightpanel">
			<ul class="breadcrumbs">
				...
				<li><a href="table-static.html">首页管理</a> <span
					class="separator"></span></li>
				<li>更换轮播图片</li>
			...
			<div class="maincontent">
				<div class="maincontentinner">
					...
					<form method="post" action="../BackendImageUpload.do" enctype="multipart/form-data">
					<p>
						<label>选择序号</label> <span class="formwrapper"> <select
							data-placeholder="选择上传第几张轮播图" style="width: 350px"
							class="chzn-select" tabindex="2" name="index">
								<option value=""></option>
								<option value="1">第1张</option>
								<option value="2">第2张</option>
								<option value="3">第3张</option>
								<option value="4">第4张</option>
								<option value="5">第5张</option>
										...
										<div class="fileupload fileupload-new"
											...
											<div class="input-append">
												...
												<span class="btn btn-file"><span
													...
													id="image" name="image"/></span> <a href="#" class="btn fileupload-exists"
