    ...
    <div class="leftpanel">
            ...
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown"><a href=""><span class="iconfa-pencil"></span>学生管理</a>
                	<ul>
                        ...
                        <li><a href="studentcourselist.jsp">浏览学生</a></li>
                        <li><a href="editstudent.jsp">编辑学生</a></li>
                    </ul>
                </li>
                <li class="dropdown active"><a href=""><span class="iconfa-pencil"></span>选课管理</a>
                	<ul style="display:block;">
                    	<li><a href="../BackendNewStudentCourseServlet">新建选课</a></li>
                        <li class="active"><a href="studentlist.jsp">浏览选课</a></li>
		...
		<div class="rightpanel">
			<ul class="breadcrumbs">
				...
				<li><a href="table-static.html">选课管理</a> <span
					class="separator"></span></li>
				<li>浏览选课</li>
