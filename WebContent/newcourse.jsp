    ...
    <div class="leftpanel">
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href=""><span class="iconfa-pencil"></span>课程管理</a>
                	<ul style="display:block;">
                    	<li class="active"><a href="../BackendNewCourseServlet">新建课程</a></li>
		...
		<div class="rightpanel">
			<ul class="breadcrumbs">
				...
				<li><a href="forms.html">课程管理</a> <span class="separator"></span></li>
				<li>新建课程</li>
